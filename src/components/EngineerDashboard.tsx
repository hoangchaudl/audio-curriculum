  ...
  return (
    <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#F5FAFF]">
      <header className="h-20 bg-white border-b-[3px] border-black flex items-center justify-between px-10 flex-shrink-0">
        <div>
          <h2 className="text-2xl font-black text-black">Module {mod.label || mod.order.toString().padStart(2, '0')} Tasks</h2>
        ...
        <div className="space-y-6">
          ...
          {modSubmissions.length === 0 ? (
            ...
            modSubmissions.map(sub => {
              ...
              return (
                <div key={sub.id} className="bg-white rounded-2xl p-6 border-[3px] border-black flex flex-col gap-4">
